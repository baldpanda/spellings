...
class Worksheet:
    ...
    def write_to_text_file(self, list_of_words):
        self.get_introduction(list_of_words)
        self.get_words_with_blanks(list_of_words)
...
# print(example_worksheet.write_to_text_file(["tree", "cat"]))

    # def main():
    #     example_worksheet = Worksheet()
    #     list_of_words = input('Please enter a list of words: '.format(word))
    #     example_worksheet.get_introduction(list_of_words)
    #     example_worksheet.get_words_with_blanks(list_of_words)
